...
\begin{itemize}
    ...
    \item Automate timetables and event scheduling within the system.
...
\begin{itemize}
    \item Administrators, Teachers, and the Management Panel can publish announcements through the system.
...
\textbf{5. Student Behaviour Records}
\begin{itemize}
...
\textbf{5. Grade, Class, Subject, and Class Teacher Management}
\begin{itemize}
    \item The Administrator can create and manage grades, classes, and subjects within the system.
    \item The Administrator can assign teachers to their respective classes as class teachers.
\end{itemize}

\subsection{Students}

\begin{enumerate}
    \item \textbf{View Marks:} The system allows students to view their subject-wise marks and final examination marks.
    ...
    \item \textbf{View Exam Timetable:} The student is able to view the exam timetable that was uploaded by the Management Panel or the Administrator.
    \item \textbf{View Absent Reason:} The system allows parents and students to view the status of their submitted absence reasons.
...
\begin{itemize}
    \item The user navigates to the academic performance module, selects a student or group of students, and the system retrieves academic records including grades, exam results, and progress reports for analysis and monitoring.
\end{itemize}
...
\begin{itemize}
    ...
    \item The system does not include an automated external notification system (such as email, SMS, or push notifications) in this phase. Any verification mechanisms, such as OTP generation, are handled internally within the system interface without using external communication services. In future deployment stages, email or SMS-based notifications can be added once the project moves to a scalable, funded environment.
...
\addlinespace
Subject Management Module & Create and delete subjects. \\
\addlinespace
Assign Class Teacher Module & Assign teachers to their respective classes. \\
\end{longtable}
...
\noindent\textit{Note: The OTP used in this workflow is generated and verified within the system interface. Since external notification systems such as email or SMS are not implemented in this phase, the OTP is not delivered via external communication channels.}
...
All functionalities defined in the project proposal and interim report have been \textbf{100\% completed}. The system consists of \textbf{19 functional modules}, distributed among four group members as follows:
...
\begin{enumerate}
    ...
    \item Student Absence Reason Management (CRUD)
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Assign Class Teacher Module
\end{enumerate}
...
All team members contributed equally (25\% each) to the overall project, including system design, database design, frontend development, backend development, testing, and integration. The primary module ownership and contribution details are as follows:
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Update:} Edit personal data.
  \item \textbf{Update:} Assign classes to teachers.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Register admissions and assign students to a class/grade.
  \item \textbf{Read:} List students by class/grade, search, and view full student profiles.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Add guardian profiles and link to student(s).
  ...
  \item \textbf{Delete:} Prefer deactivation to keep announcement delivery logs and history.
\end{itemize}

\subsubsection*{Rules}
A student has only one guardian.
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Submit absence reasons for a student and date/period.
  ...
  \item \textbf{Delete:} Remove absence reasons after acknowledgement, if required.
\end{itemize}

\subsubsection*{Acknowledgement Workflow}
\begin{itemize}[leftmargin=*]
  \item Statuses: \textit{Submitted/Pending} $\rightarrow$ \textit{Acknowledged} or \textit{Not Acknowledged}.
  \item An approver can record decision timestamps.
  \item Optionally notify the parent/guardian when acknowledged or not.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Read:} View the announcement feed.
  \item \textbf{Update:} Edit announcement content and audience.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Update:} Replace files or update metadata.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Read:} View attendance records and summaries.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Read:} View class registers, student-wise history, and monthly summaries.
  \item \textbf{Update:} Correct entries.
  \item \textbf{Delete:} Remove invalid entries (update preferred).
\end{itemize}

\subsection{Assign Class Teacher Module}
\textbf{Purpose:} Assign class teachers to the relevant classes and maintain class-teacher responsibility mappings.

\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Assign:} Assign a teacher to a class as the class teacher.
  \item \textbf{Read:} View current class-teacher assignments.
  \item \textbf{Update:} Change assigned class teachers when necessary.
  \item \textbf{Remove:} Remove or replace an incorrect assignment.
\end{itemize}

\subsubsection*{Rules}
A class should have only one active class teacher assignment at a time.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Read:} View student reports, subject analysis, and class summaries.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Build timetable entries per day/period with subject and teacher.
  \item \textbf{Read:} View timetable grids and printable versions.
  \item \textbf{Update:} Edit periods and swap subjects/teachers.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Assign a relief teacher for a class, date, and period.
  \item \textbf{Read:} View daily relief schedules by class and by teacher.
  \item \textbf{Update:} Replace substitute teachers or adjust periods.
  \item \textbf{Delete:} Cancel relief assignments.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Read:} View the class list.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Upload:} Upload timetable images with exam metadata.
  \item \textbf{Update:} Replace uploaded files and/or update metadata.
  \item \textbf{Delete:} Remove timetable entries and physical files.
\end{itemize}
...
\subsubsection*{CRUD Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Submit leave requests (type, date range, reason, attachment).
  \item \textbf{Read:} Teachers view their own requests; management views all pending/processed requests.
  \item \textbf{Update:} Teachers can edit pending requests; approvers can add notes.
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Add remarks with category and description.
  \item \textbf{Read:} View student behaviour history and class summaries.
  \item \textbf{Update:} Edit remarks with authorization controls.
  \item \textbf{Delete:} Remove incorrect remarks; preserve an audit trail when required.
\end{itemize}
...
\subsubsection*{Functions}
\begin{itemize}[leftmargin=*]
  \item \textbf{Create:} Add subjects with name and grade type.
  \item \textbf{Read:} View the subject catalogue by grade.
...
\begin{enumerate}
    ...
    \item \textbf{CRUD Operation Testing:} Comprehensive testing of all Create, Read, Update, and Delete operations across all functional modules where applicable.
...
\midrule
Total Functional Units        & 19 modules \\
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{"Diagrams/member details.png"}
\end{figure}
