...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($tab === 'Reports') {
            ...
            // Reports tab open karapu gaman class ekata adala students tika datalist ekata load karanna
            if (!empty($teacherClassId)) {
                $suggestions = $reportModel->getStudentsByClass((int)$teacherClassId);
            }

            // Search ekak dunnot witharak selected student hoyanna
