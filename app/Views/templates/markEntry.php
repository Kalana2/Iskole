...
<script>
    ...
    function removeMarks(studentId, studentName) {
        ...
        fetch('/index.php?url=markEntry/deleteMarks', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
    ...
    document.addEventListener('submit', function(e) {
        ...
        fetch('/index.php?url=markEntry/submitMarks', {
                method: 'POST',
                body: formData
            })
            .then(r => {
    ...
    if (_loadBtn) {
        _loadBtn.addEventListener('click', function(e) {
            ...
            formData.append('class', classVal);
            formData.append('term', term);
            fetch('/index.php?url=markEntry/loadStudents', {
                    method: 'POST',
                    body: formData
                })
                .then(r => {
        ...
        try {
            ...
            if (!summary) {
                ...
                if (box) {
                    ...
                    if (statsGrid) box.insertBefore(summary, statsGrid);
                    else box.appendChild(summary);
                }
            }
            if (summary) {
