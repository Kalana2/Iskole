<div class="admin-container">
    ...
    $items = ['Announcements', 'Management', 'Material', 'Student Attendance', 'Teacher Attendance', 'Exam Marks', 'Time Tables', 'Relief', 'Exam Time Table', 'TLR', 'Behaviour']; // 'Class & Subjects', 
